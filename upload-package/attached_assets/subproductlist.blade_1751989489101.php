				...
				<div class="container">
				    <div class="col-md-12 mt-5 p-0">
						...
						<ol class="breadcrumb bgdetailproduct">
							...
							<li class="breadcrumb-item"><a class="euz_font12 euz_newfont  text-white" href="<?php echo url('/subproduct/'.$categories[0]->catid); ?>"><?php echo ucwords(strtolower($categories[0]->catname)); ?></a></li>
							<?php } if(!empty($categories[0]->subcatname)) { ?>
							<li class="breadcrumb-item a_breadcrumbsub"><span class="euz_font12 euz_newfont txt_ylo"><?php echo ucwords(strtolower($categories[0]->subcatname)); ?></span></li>
							<?php } ?>
						</ol>
					</div>
					<div class="row my-5">
						...
						<div class="col-lg-3 col-md-4 mt-2">
							<a href="<?php echo url('/productdetail/'.$category->id); ?>">
								<div class="bg-white incms">
									<img src="{{ url('admin/public/img/product/'.$category->img) }}" class="img-fluid zoom" alt="<?php echo $category->title; ?>" />
									<div class="overlay"><div class="text"><input type="button" class="btn btn-customslider" value="More Info"></div></div>
								</div>
								<div class="boxgreen1 border p-2"><p class="mb-0"><?php echo $category->title; ?></p></div>
							</a>
						</div>
						<?php } ?>						
					</div>            
