                    ...
                    <div class="row border p-3 m-2 nextmod2pop">
						...
						<div class="col-lg-8 pad0">
    						...
    						<div class="form-group col-lg-3 col-md-4" id="fullpapop">
                                ...
                                <!---<input type="text" class="form-control" id="fullamt" name="fullamt" value="<?php //if(!empty($event[0]->fee)) { echo $vat; } ?>" readonly>--->
                                <input type="text" class="form-control" id="fullamt" name="fullamt" value="<?php if(!empty($event[0]->fee)) { echo $payableamt; } ?>" readonly>
                                ...
                                <input type='hidden' name='item_name' value='<?php echo $event[0]->id; ?>,<?php echo $event[0]->title; ?>,<?php echo $username; ?>,<?php echo $useremail; ?>,<?php echo $usermobile; ?>,<?php echo $useridlog; ?>,Event,Online,<?php echo $payableamt; ?>,<?php echo $event[0]->firstamt; ?>,<?php echo $event[0]->secondamt; ?>'> 
                                <?php } ?>
    						...
    						<div class="form-group col-lg-3 col-md-4" id="fullpapop1">
                                ...
                                <input type="text" class="form-control" id="halfamt" name="halfamt" value="<?php if(!empty($event[0]->fee)) { echo $event[0]->firstamt; } ?>" readonly>
                            </div>
    						...
    						<div class="form-group col-lg-3 col-md-4" id="fullpapop11">
                                ...
                                <input type="text" class="form-control" id="" name="balamt" value="<?php if(!empty($event[0]->fee)) { echo $balamt; } ?>" readonly>
                            </div>
