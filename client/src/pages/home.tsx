    ...
    <div className="pt-20">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute inset-0" style={{backgroundImage: 'url("data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffeb3b" fill-opacity="0.4"%3E%3Ccircle cx="30" cy="30" r="1"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")'}}></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-text-dark">Upcoming Seminars</h3>
                </div>
                
                <div className="space-y-6">
                  {seminars && seminars.length > 0 ? (
                    seminars.slice(0, 3).map((seminar) => (
                      <div key={seminar.id} className="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all duration-300 hover:bg-white border border-gray-100">
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center mb-2">
                              <span className="bg-primary-gold text-black px-3 py-1 rounded-full text-xs font-medium">
                                Upcoming
                              </span>
                            </div>
                            <h4 className="font-semibold text-lg mb-2 text-text-dark">{seminar.title}</h4>
                            ...
                            <Link href={`/seminars/${seminar.id}`}>
                              <Button size="sm" style={{backgroundColor: '#ffeb3b', color: '#000'}} className="hover:opacity-90 transition-all duration-300">
                                Learn More
                              </Button>
                            </Link>
                          </div>
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-text-gray">No upcoming seminars at the moment.</p>
                    </div>
                  )}
                </div>
                ...
                <div className="mt-8 text-center">
                  <Link href="/seminars">
                    <Button style={{backgroundColor: '#8bc34a', color: '#fff'}} className="hover:opacity-90 px-6 py-3 rounded-lg transition-all duration-300">
                      View All Seminars
                    </Button>
                  </Link>
                </div>
            ...
            <div>
              <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg">
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-secondary-green rounded-full flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                    </svg>
                  </div>
                  <h3 className="text-2xl font-bold text-text-dark">Recent Events</h3>
                </div>
                
                <div className="space-y-6">
                  {events && events.length > 0 ? (
                    events.slice(0, 3).map((event) => (
                      <div key={event.id} className="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all duration-300 hover:bg-white border border-gray-100">
                        <div className="flex items-start space-x-4">
                          <img
                          ...
                          />
                          <div className="flex-1">
                            <h4 className="font-semibold text-lg mb-2 text-text-dark">{event.title}</h4>
                            <p className="text-text-gray text-sm mb-3">
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-text-gray">No recent events.</p>
                    </div>
                  )}
                </div>
