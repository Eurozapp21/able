        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Link href="/products?category=sensory-integration" className="group">
                  <div className="flex items-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-all hover:bg-bg-yellow-light">
                    ...
                    <span className="font-medium text-text-dark group-hover:text-primary-gold transition-colors">Sensory Integration</span>
                  </div>
                </Link>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -right-6 w-32 h-32 bg-primary-gold opacity-10 rounded-full z-0"></div>
              <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-secondary-green opacity-10 rounded-full z-0"></div>
            </div>
          </div>
        </div>
      </section>
